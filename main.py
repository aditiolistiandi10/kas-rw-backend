...
# PERBAIKAN: Mengubah 'fastAPI' menjadi 'fastapi' (huruf kecil semua)
...
# Saran perbaikan: Mengubah nama class menjadi PascalCase sesuai standar Python (UpdateTransaksi)
